...
public class CarStageThree : MonoBehaviour
{
    ...
    void CanContinueMoving(Transform currentPoint)
    {
        ...
        {
            MyEvent.MoveToSuspendPointEventStageThree.Invoke();
            Debug.Log("移动到红绿灯事件触发  到红绿灯了");
            return;
        }
        if (currentPoint == SuspendPointB)
        {
            MyEvent.MoveToSuspendPointEventStageThreeB.Invoke();
            Debug.Log("移动到点B事件触发  到点B了");
            return;
        }
        if (currentPoint == SuspendPointC)
        {
            MyEvent.MoveToSuspendPointEventStageThreeC.Invoke();
        ...
        else if (currentPoint == EndPoint)
        {
            ...
            MyEvent.MoveToSuspendPointEventStageThreeEnd.Invoke();
            return;
        }
        else
        {
